$("document").ready(function(){
            ...
            function blue_and_copy(){
                $("td#copy_to_clipboard").mouseover(function(){
                    ...
                    $(this).children().css({"visibility":"visible", "margin-top":"25px", "margin-left":"50px", "padding-left":"2px",
                                            "padding-right":"2px","border":"1px solid black", "background-color":"#F0E68C", "color":"black",
                                            "font-size":"4px"});
                });
