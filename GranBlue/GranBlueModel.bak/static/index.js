            ...
            function ajax_all_boss(){
                $.getJSON('/ajax_all_boss/', function(ret){
                    ...
                    for (var i = 0; i <= ret.length - 1; i++) {
                        ...
                        $('#all_boss').append("<tr><td>" + boss + "</td><td>" + level + '</td><td id="copy_to_clipboard">' + code + "</td></tr>");
                    };
                    blue_and_copy();
                })}
            ...
            function ajax_tiamat(){
                $.getJSON('/ajax_tiamat/', function(ret){
                    ...
                    for (var i = 0; i <= ret.length - 1; i++) {
                        var level = ret[i].split(",")[1];
                        var code = ret[i].split(",")[2];
                        $('#tiamat').append("<tr><td>" + level + '</td><td id="copy_to_clipboard">' + code + "</td></tr>");
                    };
                    blue_and_copy();
                })}
            ...
            function ajax_colossus(){
                $.getJSON('/ajax_colossus/', function(ret){
                    ...
                    for (var i = 0; i <= ret.length - 1; i++) {
                        var level = ret[i].split(",")[1];
                        var code = ret[i].split(",")[2];
                        $('#colossus').append("<tr><td>" + level + '</td><td id="copy_to_clipboard">' + code + "</td></tr>");
                    };
                    blue_and_copy();
                })}
            ...
            function ajax_leviathan(){
                $.getJSON('/ajax_leviathan/', function(ret){
                    ...
                    for (var i = 0; i <= ret.length - 1; i++) {
                        var level = ret[i].split(",")[1];
                        var code = ret[i].split(",")[2];
                        $('#leviathan').append("<tr><td>" + level + '</td><td id="copy_to_clipboard">' + code + "</td></tr>");
                    };
                    blue_and_copy();
                })}
            ...
            function ajax_yggdrasil(){
                $.getJSON('/ajax_yggdrasil/', function(ret){
                    ...
                    for (var i = 0; i <= ret.length - 1; i++) {
                        var level = ret[i].split(",")[1];
                        var code = ret[i].split(",")[2];
                        $('#yggdrasil').append("<tr><td>" + level + '</td><td id="copy_to_clipboard">' + code + "</td></tr>");
                    };
                    blue_and_copy();
                })}
            ...
            function ajax_celeste(){
                $.getJSON('/ajax_celeste/', function(ret){
                    ...
                    for (var i = 0; i <= ret.length - 1; i++) {
                        var level = ret[i].split(",")[1];
                        var code = ret[i].split(",")[2];
                        $('#celeste').append("<tr><td>" + level + '</td><td id="copy_to_clipboard">' + code + "</td></tr>");
                    };
                    blue_and_copy();
                })}
            ...
            function ajax_luminiera(){
                $.getJSON('/ajax_luminiera/', function(ret){
                    ...
                    for (var i = 0; i <= ret.length - 1; i++) {
                        var level = ret[i].split(",")[1];
                        var code = ret[i].split(",")[2];
                        $('#luminiera').append("<tr><td>" + level + '</td><td id="copy_to_clipboard">' + code + "</td></tr>");
                    };
                    blue_and_copy();
                })}
